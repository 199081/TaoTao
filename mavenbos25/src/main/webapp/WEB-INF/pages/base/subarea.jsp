...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn").click(function(){
			//alert("执行查询...");
			//load方法的参数就是业务条件参数（json），datagrid会自动缓存到组件中。
			//$("#grid").datagrid("load",{'name':'rose','age':18});
			//$("#grid").datagrid("load",);
			//alert($("#queryForm").serialize());
			//alert($("#queryForm").serializeArray());//循环重新组装
			//alert($("#queryForm").serializeJson());//循环重新组装
			//获取表单的json对象
			//alert($("#queryForm").serializeJson().province);//
			$("#grid").datagrid("load",$("#queryForm").serializeJson());
...
<body class="easyui-layout" style="visibility:hidden;">
					...
					<tr>
						...
						<td>
							<input class="easyui-combobox" name="region.id"  required="true"
    							...
    							,url:'${pageContext.request.contextPath }/region_list.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<div class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="queryForm" action="${pageContext.request.contextPath }/subarea_export.action" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
