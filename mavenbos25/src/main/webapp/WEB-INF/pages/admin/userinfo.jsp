...
<script type="text/javascript">
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/role_list.action",function(data){
			...
			$(data).each(function(){
				//构建checkedbox
				//知识点：jquery将dom对象转成jquery对象的时候，里面只能是一个元素<p>aa<input><p>
				var roleCheckbox=$("<span><input type='checkbox' name='roleIds' value='"+this.id+"'/>"+this.name+"</span>");
				//将checkedbox添加到td中
				$("#roleSelectTD").append(roleCheckbox);
			});
		});
...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="form" action="${pageContext.request.contextPath }/user_save.action" method="post" >
